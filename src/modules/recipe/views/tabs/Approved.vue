...
import RecipeSimpleList from "@/modules/recipe/components/RecipeOverviewItem/SimpleList.vue";
...
onMounted(() => {
  recipeStore.fetchRecipes({status: 'verified'});
});
</script> -->
